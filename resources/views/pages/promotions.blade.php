...
@push('scripts')
    <script>
        ...
        function updateEstabList(type) {
            ...
            sel.innerHTML = list.length ? list.map(n => `<option>${n}</option>`).join('') :
                '<option>— Choisir d\'abord le type —</option>';
        }

        function updateDiscountField(type) {
            const f = document.getElementById('discountField');
            const inp = f.querySelector('input');
            if (type === 'service_gratuit' || type === 'offre_speciale') {
                f.style.opacity = '.4';
                inp.disabled = true;
                inp.placeholder = 'N/A';
            } else {
                f.style.opacity = '1';
                inp.disabled = false;
                inp.placeholder = type === 'discount_pct' ? 'Ex: 20 (pour 20%)' : 'Ex: 2000 (FCFA)';
            }
        }

        function editPromo(id) {
            openModal('modalAddPromo');
        }

        function togglePromo(id) {
            showToast('Promotion mise en pause', 'warning');
        }

        function deletePromo(id) {
            confirmAction('Supprimer cette promotion ?', () => showToast('Promotion supprimée', 'error'));
        }

        function sendPushPromo(id) {
            confirmAction('Envoyer une notification push maintenant ?', () => showToast('Notification push envoyée',
                'success'));
        }

        function duplicatePromo(id) {
            showToast('Promotion dupliquée — modifiez les dates', 'info');
        }
...
@section('content')
    <main class="page-content">
        <div class="page-header"
            ...
            <button class="btn btn-primary" onclick="openModal('modalAddPromo')"><i class="fa-solid fa-plus"></i>
                Créer une promotion</button>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:14px;margin-bottom:20px">
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#D1FAE5;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-tag" style="color:var(--success)"></i></div>
                    <div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#F1F5F9;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-clock-rotate-left" style="color:var(--text-muted)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">41</div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#FFF0EB;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-gas-pump" style="color:var(--primary)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">15</div>
        ...
        <div class="card">
            <div class="filter-bar">
                <div style="position:relative;flex:1;min-width:200px">
                    ...
                    <input type="text" placeholder="Titre, établissement..."
                ...
                <select class="form-select" style="width:150px">
                    ...
                    <option>Offre spéciale</option>
                </select>
                <select class="form-select" style="width:150px">
                    <option>Tout type d'établ.</option>
            ...
            <div class="table-wrapper">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="fw-600" style="font-size:13px">Lavage offert pour tout plein 20L+
                                </div>
                            ...
                            <td>
                                <span style="display:flex;align-items:center;gap:5px;font-size:12px;font-weight:600">
                                    <i class="fa-solid fa-gas-pump" style="color:var(--primary);font-size:10px"></i> Total
                                    Énergies Cocody
                                </span>
                            </td>
                            ...
                            <td><span class="badge badge-success"><i class="fa-solid fa-circle" style="font-size:7px"></i>
                                    Active</span></td>
                            <td><span class="badge badge-success"><i class="fa-solid fa-paper-plane"
                                        style="font-size:9px"></i> Oui</span></td>
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="editPromo(1)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#" onclick="togglePromo(1)"><i
                                                class="fa-solid fa-pause"></i> Désactiver</a>
                                        <a class="dropdown-item" href="#" onclick="sendPushPromo(1)"><i
                                                class="fa-solid fa-paper-plane"></i> Renvoyer push</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deletePromo(1)"><i
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display:flex;align-items:center;gap:5px;font-size:12px;font-weight:600">
                                    <i class="fa-solid fa-wrench" style="color:#8B5CF6;font-size:10px"></i> Garage
                                    Auto Plus
                                </span>
                            </td>
                            ...
                            <td><span class="badge badge-success"><i class="fa-solid fa-circle"
                                        style="font-size:7px"></i> Active</span></td>
                            <td><span class="badge badge-success"><i class="fa-solid fa-paper-plane"
                                        style="font-size:9px"></i> Oui</span></td>
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="editPromo(2)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#" onclick="togglePromo(2)"><i
                                                class="fa-solid fa-pause"></i> Désactiver</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deletePromo(2)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display:flex;align-items:center;gap:5px;font-size:12px;font-weight:600">
                                    <i class="fa-solid fa-gas-pump" style="color:var(--primary);font-size:10px"></i> Shell
                                    Plateau
                                </span>
                            </td>
                            ...
                            <td><span class="badge badge-info"><i class="fa-solid fa-clock" style="font-size:7px"></i> À
                                    venir</span></td>
                            <td><span class="badge badge-gray"><i class="fa-solid fa-times" style="font-size:9px"></i>
                                    Non</span></td>
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="editPromo(3)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#" onclick="sendPushPromo(3)"><i
                                                class="fa-solid fa-paper-plane"></i> Envoyer push maintenant</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deletePromo(3)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
                        ...
                        <tr style="opacity:.6">
                            ...
                            <td>
                                <span style="display:flex;align-items:center;gap:5px;font-size:12px;font-weight:600">
                                    <i class="fa-solid fa-wrench" style="color:#8B5CF6;font-size:10px"></i> Centre
                                    Vidange Express
                                </span>
                            </td>
                            ...
                            <td><span class="badge badge-gray"><i class="fa-solid fa-circle" style="font-size:7px"></i>
                                    Expirée</span></td>
                            <td><span class="badge badge-success"><i class="fa-solid fa-paper-plane"
                                        style="font-size:9px"></i> Oui</span></td>
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="duplicatePromo(4)"><i
                                                class="fa-solid fa-copy"></i> Dupliquer</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deletePromo(4)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
        ...
        <div class="modal-box" style="max-width:580px">
            ...
            <div class="modal-body">
                <div style="display:flex;flex-direction:column;gap:14px">
                    <div><label class="form-label">Titre de la promotion *</label><input type="text"
                            class="form-control" placeholder="Ex: Lavage offert pour tout plein de 20L+"></div>
                    <div><label class="form-label">Description</label>
                        <textarea class="form-control" rows="2" placeholder="Détails de l'offre..."></textarea>
                    </div>
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        ...
                        <div>
                            ...
                            <select class="form-select" id="estabSelect">
                                <option>— Choisir d'abord le type —</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div
                        style="padding:14px;background:var(--bg);border-radius:var(--radius-sm);border:1px solid var(--border)">
                        <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
                            <label class="toggle"><input type="checkbox" id="sendPushCheck"><span
                                    class="toggle-slider"></span></label>
                            <div>
                                <div class="fw-600" style="font-size:13px">Envoyer une notification push</div>
                                <div style="font-size:12px;color:var(--text-muted)">Notifier les utilisateurs proches
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="savePromo()"><i class="fa-solid fa-check"></i> Créer la
                    promotion</button>
            </div>
        </div>
    </div>
