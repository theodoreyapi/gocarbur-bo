...
@push('scripts')
    <script>
        ...
        function toggleBanner(id) {
            showToast('Statut bannière mis à jour', 'info');
        }

        function deleteBanner(id) {
            confirmAction('Supprimer cette bannière ?', () => showToast('Bannière supprimée', 'error'));
        }
...
@section('content')
    <main class="page-content">
        <div class="page-header"
            ...
            <button class="btn btn-primary" onclick="openModal('modalAddBanner')"><i class="fa-solid fa-plus"></i>
                Nouvelle bannière</button>
        </div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#D1FAE5;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-rectangle-ad" style="color:var(--success)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">6</div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#DBEAFE;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-eye" style="color:var(--info)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">48 240</div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#FFF0EB;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-arrow-pointer" style="color:var(--primary)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">1 847</div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#FEF3C7;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-percent" style="color:var(--warning)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">3.8%</div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:16px;margin-bottom:24px">
            ...
            <div class="card" style="overflow:hidden">
                <div
                    style="height:100px;background:linear-gradient(135deg,#FF6B35,#FF9A6C);display:flex;align-items:center;justify-content:center;position:relative">
                ...
                <div class="card-body">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
                        <div>
                            ...
                            <div style="font-size:12px;color:var(--text-muted)">Position : Bannière accueil
                                principale</div>
                        </div>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" onclick="editBanner(1)"><i
                                        class="fa-solid fa-pen"></i> Modifier</a>
                                <a class="dropdown-item" href="#" onclick="toggleBanner(1)"><i
                                        class="fa-solid fa-pause"></i> Désactiver</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" href="#" onclick="deleteBanner(1)"><i
            ...
            <div class="card" style="overflow:hidden">
                <div
                    style="height:100px;background:linear-gradient(135deg,#3B82F6,#1D4ED8);display:flex;align-items:center;justify-content:center;position:relative">
                    <div style="text-align:center;color:#fff">
                ...
                <div class="card-body">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
                        <div>
                            ...
                            <div style="font-size:12px;color:var(--text-muted)">Position : Entre articles conseils
                            </div>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                    class="fa-solid fa-ellipsis"></i></button>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" onclick="editBanner(2)"><i
                                        class="fa-solid fa-pen"></i> Modifier</a>
                                <a class="dropdown-item" href="#" onclick="toggleBanner(2)"><i
                                        class="fa-solid fa-pause"></i> Désactiver</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" href="#" onclick="deleteBanner(2)"><i
                                        class="fa-solid fa-trash"></i> Supprimer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="font-size:11px;color:var(--text-muted)">15 Mar → 15 Avr 2024 • Ciblage : Premium
                        uniquement</div>
                </div>
            </div>
            ...
            <div class="card" style="overflow:hidden;opacity:.65">
                <div
                    style="height:100px;background:linear-gradient(135deg,#64748B,#475569);display:flex;align-items:center;justify-content:center;position:relative">
                    <div style="text-align:center;color:#fff">
                        <div style="font-size:16px;font-weight:800">Promo Total CI</div>
                        <div style="font-size:12px;opacity:.9">Campagne terminée</div>
                    </div>
                    <div style="position:absolute;top:8px;right:8px">
                        <span class="badge badge-gray"><i class="fa-solid fa-circle" style="font-size:7px"></i>
                            Désactivée</span>
                    </div>
                </div>
                <div class="card-body">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                    class="fa-solid fa-ellipsis"></i></button>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" onclick="toggleBanner(3)"><i
                                        class="fa-solid fa-play"></i> Réactiver</a>
                                <a class="dropdown-item" href="#" onclick="editBanner(3)"><i
                                        class="fa-solid fa-pen"></i> Modifier</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" href="#" onclick="deleteBanner(3)"><i
                                        class="fa-solid fa-trash"></i> Supprimer</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title"><i class="fa-solid fa-table" style="color:var(--info)"></i> Vue tableau —
                    Toutes les bannières</div>
            </div>
                            ...
                            <td>
                                <div class="dropdown"><button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                    ...
                                    <div class="dropdown-menu"><a class="dropdown-item" href="#"><i
                                                class="fa-solid fa-pen"></i> Modifier</a><a class="dropdown-item"
                                            href="#"><i class="fa-solid fa-pause"></i> Désactiver</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown"><button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                    ...
                                    <div class="dropdown-menu"><a class="dropdown-item" href="#"><i
                                                class="fa-solid fa-pen"></i> Modifier</a><a class="dropdown-item"
                                            href="#"><i class="fa-solid fa-pause"></i> Désactiver</a></div>
                                </div>
                            </td>
                        </tr>
                        <tr style="opacity:.65">
        ...
        <div class="modal-box" style="max-width:560px">
            ...
            <div class="modal-body">
                <div style="display:flex;flex-direction:column;gap:14px">
                    <div><label class="form-label">Nom interne *</label><input type="text" class="form-control"
                            placeholder="Ex: Castrol GTX — Accueil Mars 2024"></div>
                    ...
                    <div><label class="form-label">Image de la bannière (recommandé : 1200×400 px)</label><input
                            type="file" class="form-control" accept="image/*"></div>
                    <div><label class="form-label">URL de destination (lien au clic)</label><input type="url"
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveBanner()"><i class="fa-solid fa-check"></i> Créer la
                    bannière</button>
            </div>
        </div>
    </div>
