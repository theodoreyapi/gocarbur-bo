...
@push('scripts')
    <script>
        ...
        function filterByType(v) {
            if (v) showToast('Filtre type : ' + v, 'info');
        }

        function filterByPlan(v) {
            if (v) showToast('Filtre plan : ' + v, 'info');
        }

        function filterVerifiedOnly() {
            showToast('Affichage des garages vérifiés uniquement', 'info');
        }
        ...
        function verifyGarage(id) {
            showToast('Badge vérifié attribué', 'success');
            closeModal('modalViewGarage');
        }

        function unverifyGarage(id) {
            confirmAction('Retirer le badge vérifié ?', () => showToast('Badge retiré', 'warning'));
        }

        function deleteGarage(id) {
            confirmAction('Supprimer ce garage ?', () => showToast('Garage supprimé', 'error'));
        }

        function saveGarage() {
            showToast('Garage enregistré avec succès', 'success');
            closeModal('modalAddGarage');
        }

        function saveServices() {
            showToast('Services mis à jour', 'success');
    ...
    <main class="page-content">
        ...
        <div class="page-header"
            ...
            <div style="display:flex;gap:10px">
                <button class="btn btn-secondary" onclick="exportGarages()"><i class="fa-solid fa-download"></i>
                    Export CSV</button>
                <button class="btn btn-primary" onclick="openModal('modalAddGarage')"><i class="fa-solid fa-plus"></i> Ajouter
                    garage</button>
            </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:14px;margin-bottom:20px">
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#EDE9FE;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-wrench" style="color:#8B5CF6"></i></div>
                    <div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#D1FAE5;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-shield-check" style="color:var(--success)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">98</div>
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#DBEAFE;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-crown" style="color:var(--info)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">47</div>
                        <div class="stat-label">Pro / Premium</div>
                    </div>
                </div>
            </div>
            <div class="stat-card" style="padding:16px">
            ...
            <div class="stat-card" style="padding:16px">
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="stat-icon" style="background:#FEE2E2;margin:0;width:40px;height:40px;font-size:17px"><i
                            class="fa-solid fa-ban" style="color:var(--danger)"></i></div>
                    <div>
                        <div class="stat-value" style="font-size:22px">11</div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:10px;margin-bottom:20px">
            <div
                style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;display:flex;align-items:center;gap:10px">
                <i class="fa-solid fa-car-wrench" style="color:#8B5CF6;font-size:18px;width:22px;text-align:center"></i>
                <div>
                    <div class="fw-700" style="font-size:15px">48</div>
                    <div style="font-size:11px;color:var(--text-muted)">Garage général</div>
                </div>
            </div>
            <div
                style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;display:flex;align-items:center;gap:10px">
                ...
                <div>
                    <div class="fw-700" style="font-size:15px">24</div>
                    <div style="font-size:11px;color:var(--text-muted)">Centre vidange</div>
                </div>
            </div>
            <div
                style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;display:flex;align-items:center;gap:10px">
                ...
                <div>
                    <div class="fw-700" style="font-size:15px">31</div>
                    <div style="font-size:11px;color:var(--text-muted)">Lavage auto</div>
                </div>
            </div>
            <div
                style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;display:flex;align-items:center;gap:10px">
                ...
                <div>
                    <div class="fw-700" style="font-size:15px">18</div>
                    <div style="font-size:11px;color:var(--text-muted)">Pneus</div>
                </div>
            </div>
            <div
                style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;display:flex;align-items:center;gap:10px">
                ...
                <div>
                    <div class="fw-700" style="font-size:15px">22</div>
                    <div style="font-size:11px;color:var(--text-muted)">Électricité auto</div>
                </div>
            </div>
            <div
                style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;display:flex;align-items:center;gap:10px">
                ...
                <div>
                    <div class="fw-700" style="font-size:15px">13</div>
                    <div style="font-size:11px;color:var(--text-muted)">Dépannage</div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:10px">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:11px;color:var(--text-muted)">Rue des Jardins, Cocody
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <span class="badge badge-success"><i class="fa-solid fa-circle"
                                        style="font-size:7px"></i> Actif</span>
                                <i class="fa-solid fa-shield-check"
                                    style="color:var(--success);margin-left:5px;font-size:13px" title="Vérifié"></i>
                            </td>
                            <td>3 247</td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="viewGarage(1)"><i
                                                class="fa-solid fa-eye"></i> Voir détail</a>
                                        <a class="dropdown-item" href="#" onclick="editGarage(1)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#" onclick="manageServices(1)"><i
                                                class="fa-solid fa-list"></i> Gérer services</a>
                                        <a class="dropdown-item" href="#" onclick="unverifyGarage(1)"><i
                                                class="fa-solid fa-shield-xmark"></i> Retirer badge</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deleteGarage(1)"><i
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:10px">
                                    <div
                                        style="width:38px;height:38px;background:#D1FAE5;border-radius:9px;display:flex;align-items:center;justify-content:center">
                            ...
                            <td>Abidjan</td>
                            <td>
                                <div style="display:flex;align-items:center;gap:4px"><i class="fa-solid fa-star"
                                        style="color:var(--warning);font-size:12px"></i><span class="fw-600">4.2</span>
                                </div>
                            </td>
                            <td>18</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="viewGarage(2)"><i
                                                class="fa-solid fa-eye"></i> Voir détail</a>
                                        <a class="dropdown-item" href="#" onclick="editGarage(2)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#"><i class="fa-solid fa-shield-check"></i>
                                            Vérifier</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deleteGarage(2)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:10px">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:11px;color:var(--text-muted)">Av. Noé, Treichville
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:4px"><i class="fa-solid fa-star"
                                        style="color:var(--warning);font-size:12px"></i><span class="fw-600">4.7</span>
                                </div>
                            </td>
                            <td>56</td>
                            <td><span class="badge badge-gray">Gratuit</span></td>
                            <td>
                                <span class="badge badge-danger"><i class="fa-solid fa-circle" style="font-size:7px"></i>
                                    Désactivé</span>
                            </td>
                            <td>987</td>
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="viewGarage(3)"><i
                                                class="fa-solid fa-eye"></i> Voir détail</a>
                                        <a class="dropdown-item" href="#"><i class="fa-solid fa-rotate-right"></i>
                                            Réactiver</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deleteGarage(3)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:10px">
                                    <div
                                        style="width:38px;height:38px;background:#FEE2E2;border-radius:9px;display:flex;align-items:center;justify-content:center">
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:4px"><i class="fa-solid fa-star"
                                        style="color:var(--warning);font-size:12px"></i><span class="fw-600">4.8</span>
                                </div>
                            </td>
                            <td>44</td>
                            <td><span class="badge badge-purple"><i class="fa-solid fa-crown" style="font-size:9px"></i>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="viewGarage(4)"><i
                                                class="fa-solid fa-eye"></i> Voir détail</a>
                                        <a class="dropdown-item" href="#" onclick="editGarage(4)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#"><i class="fa-solid fa-shield-xmark"></i>
                                            Retirer badge</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deleteGarage(4)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:10px">
                                    <div
                                        style="width:38px;height:38px;background:#FEF3C7;border-radius:9px;display:flex;align-items:center;justify-content:center">
                                        <i class="fa-solid fa-tire" style="color:#F59E0B;font-size:16px"></i>
                                    </div>
                                    <div>
                                        <div class="fw-600">Pro Pneus Marcory</div>
                                        <div style="font-size:11px;color:var(--text-muted)">Av. Houphouët, Marcory
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:4px"><i class="fa-solid fa-star"
                                        style="color:var(--warning);font-size:12px"></i><span class="fw-600">4.1</span>
                                </div>
                            </td>
                            <td>27</td>
                            <td><span class="badge badge-info"><i class="fa-solid fa-crown" style="font-size:9px"></i>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-secondary" data-toggle="dropdown"><i
                                            class="fa-solid fa-ellipsis"></i></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" onclick="viewGarage(5)"><i
                                                class="fa-solid fa-eye"></i> Voir détail</a>
                                        <a class="dropdown-item" href="#" onclick="editGarage(5)"><i
                                                class="fa-solid fa-pen"></i> Modifier</a>
                                        <a class="dropdown-item" href="#"><i class="fa-solid fa-shield-check"></i>
                                            Vérifier</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deleteGarage(5)"><i
                                                class="fa-solid fa-trash"></i>
                                            Supprimer</a>
                                    </div>
                                </div>
    ...
    <div class="modal-overlay" id="modalAddGarage">
        <div class="modal-box" style="max-width:620px">
                    ...
                    <div style="grid-column:span 2">
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:6px">
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Vidange</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Freins</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Pneus</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Batterie</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Climatisation</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Diagnostic</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Carrosserie</label>
                            <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer"><input
                                    type="checkbox"> Remorquage</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveGarage()"><i class="fa-solid fa-check"></i>
                    Enregistrer</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-box" style="max-width:640px">
            ...
            <div class="modal-body">
                <div
                    ...
                    <div
                        style="width:56px;height:56px;background:#EDE9FE;border-radius:14px;display:flex;align-items:center;justify-content:center">
                    ...
                    <div>
                        ...
                        <div style="margin-top:6px;display:flex;gap:8px;flex-wrap:wrap">
                            ...
                            <span class="badge badge-purple"><i class="fa-solid fa-crown" style="font-size:9px"></i>
                                Premium</span>
                            <span class="badge badge-success">Actif</span>
                            <span class="badge badge-success"><i class="fa-solid fa-shield-check"
                                    style="font-size:9px"></i> Vérifié</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex;gap:10px">
                    ...
                    <button class="btn btn-danger" style="flex:1"
                        onclick="confirmAction('Désactiver ce garage ?',()=>showToast('Garage désactivé','warning'))">
        ...
        <div class="modal-box" style="max-width:480px">
            ...
            <div class="modal-body">
                ...
                <div style="display:flex;flex-direction:column;gap:10px">
                    <div
                        style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:var(--bg);border-radius:var(--radius-sm);border:1px solid var(--border)">
                        <span class="fw-600" style="font-size:13px">Vidange</span>
                        <div style="display:flex;align-items:center;gap:10px">
                            <input type="text" class="form-control" value="15 000 – 25 000 FCFA"
                                style="width:180px;font-size:12px;padding:5px 9px">
                    ...
                    <div
                        ...
                        <div style="display:flex;align-items:center;gap:10px">
                            <input type="text" class="form-control" value="20 000 – 45 000 FCFA"
                                style="width:180px;font-size:12px;padding:5px 9px">
                            <label class="toggle"><input type="checkbox" checked><span
                                    class="toggle-slider"></span></label>
                        </div>
                    ...
                    <div
                        ...
                        <div style="display:flex;align-items:center;gap:10px">
                            <input type="text" class="form-control" placeholder="Fourchette de prix"
                                style="width:180px;font-size:12px;padding:5px 9px">
                            <label class="toggle"><input type="checkbox"><span class="toggle-slider"></span></label>
                        </div>
                    </div>
